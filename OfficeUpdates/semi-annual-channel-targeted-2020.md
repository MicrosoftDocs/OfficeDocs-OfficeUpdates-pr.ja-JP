...
- **[サポートに連絡] ウィンドウがドッキング可能に:** 画面の右側のペインで [サポートに連絡] ウィンドウがドッキング可能になりました。
...
- **検索して楽しむ:** 目的のアイコンを簡単に検索できるように、アイコンを挿入するための検索が追加されました。 選択しているときに、[挿入] ボタンではユーザーによって選択された数をお知らせします。 [詳細情報](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
