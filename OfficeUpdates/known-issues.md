...
|OneDrive 同期エンジンによって同期された Office ファイルに問題を特定しました。プロパティの要求およびコンテンツ タイプの要件などのドキュメントのメタデータは、[保存] および [名前を付けて保存] する際に検証されなくなりました。<br><br>**解決済みのバージョン**: <br> 月次バージョン 1906 (16.0.11727.20210)<br>SAC バージョン 1902 (16.0.11328.20426)|Word<br><br>
