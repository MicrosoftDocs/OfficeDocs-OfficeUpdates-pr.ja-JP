...
*これは、2018 年 7 月から使用可能になった半期チャネルのリリースです。 これは継続的にサポートされ、2019 年 9 月までセキュリティ更新プログラムを受信します。 ただし、新しい半期チャネル リリースが使用可能になりました — バージョン 1808 (ビルド 10730.20280) — 新しい機能、セキュリティ更新プログラム、セキュリティ以外の更新プログラムが含まれます。*
...
*これは、2018 年 1 月から使用可能になった半期チャネルのリリースです。 これは継続的にサポートされ、2019 年 3 月までセキュリティ更新プログラムを受信します。 ただし、新しい半期チャネル リリースが使用可能になりました — バージョン 1808 (ビルド 10730.20280) — 新しい機能、セキュリティ更新プログラム、セキュリティ以外の更新プログラムが含まれます。*
...
*これは、2018 年 7 月から使用可能になった半期チャネルのリリースです。 これは継続的にサポートされ、2019 年 9 月までセキュリティ更新プログラムを受信します。 ただし、新しい半期チャネル リリースが使用可能になりました — バージョン 1808 — 新しい機能、セキュリティ更新プログラム、セキュリティ以外の更新プログラムが含まれます。*
