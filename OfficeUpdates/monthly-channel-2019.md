...
## <a name="version-1911-december-10"></a><span data-ttu-id="f4ee6-111">バージョン 1911: 12 月 10 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-111">Version 1911: December 10</span></span>
...
### <a name="outlook"></a><span data-ttu-id="f4ee6-143">Outlook</span><span class="sxs-lookup"><span data-stu-id="f4ee6-143">Outlook</span></span>
...
## <a name="version-1910-november-18"></a><span data-ttu-id="f4ee6-157">バージョン 1910: 11 月 18 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-157">Version 1910: November 18</span></span>
...
## <a name="version-1910-october-30"></a><span data-ttu-id="f4ee6-173">バージョン 1910: 10 月 30 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-173">Version 1910: October 30</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="f4ee6-189">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="f4ee6-189">PowerPoint</span></span>
...
### <a name="office-suite"></a><span data-ttu-id="f4ee6-203">Office スイート</span><span class="sxs-lookup"><span data-stu-id="f4ee6-203">Office Suite</span></span>
...
### <a name="non-security-updates"></a><span data-ttu-id="f4ee6-219">セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-219">Non-security updates</span></span>
...
- <span data-ttu-id="f4ee6-249">**ファイル共有の高速化:** ファイルを開かなくても、最近使用したファイルの一覧からドキュメントを直接共有できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-249">**Faster file sharing:** Share your documents right from the recently used list without having to open the file.</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="f4ee6-264">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="f4ee6-264">PowerPoint</span></span>
...
### <a name="outlook-feature-updates"></a><span data-ttu-id="f4ee6-321">Outlook: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-321">Outlook: Feature updates</span></span>
...
## <a name="version-1907-august-13"></a><span data-ttu-id="f4ee6-339">バージョン 1907: 8 月 13 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-339">Version 1907: August 13</span></span>
...
### <a name="excel-non-security-updates"></a><span data-ttu-id="f4ee6-399">Excel: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-399">Excel: Non-security updates</span></span>
...
### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="f4ee6-430">Skype for Business: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-430">Skype for Business: Non-security updates</span></span> 
 ...
 - <span data-ttu-id="f4ee6-431">モニタの倍率が 100 ％を超えたときに、会議で Polycom CX5500 および関連デバイスからのすべてのカメラストリームを表示するように修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-431">Fix to display all camera streams from Polycom CX5500 and related devices in a meeting when your monitor is scaled more than 100%</span></span>
...
- <span data-ttu-id="f4ee6-434">Skype for Business と Microsoft Teams の参加者間のコミュニケーションのしやすさが向上</span><span class="sxs-lookup"><span data-stu-id="f4ee6-434">Improved experience for communication between Skype for Business and Microsoft Teams participants</span></span>


## <a name="version-1905-june-11"></a><span data-ttu-id="f4ee6-435">バージョン 1905: 6 月 11 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-435">Version 1905: June 11</span></span>
<span data-ttu-id="f4ee6-436">*バージョン 1905 (ビルド 11629.20246)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-436">*Version 1905 (Build 11629.20246)*</span></span>
<br/><span data-ttu-id="f4ee6-437">[こちら](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)にセキュリティ更新プログラムが記載されています</span><span class="sxs-lookup"><span data-stu-id="f4ee6-437">Security updates listed [here](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="f4ee6-438">Excel: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-438">Excel: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-439">セルが挿入または削除されたときに、ウォーターフォール図とじょうごグラフがテーブルと同期しなくなる原因となっていた問題が解決されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-439">Resolved an issue that caused Waterfall and Funnel charts to get out of sync with tables when cells were inserted or deleted.</span></span>

### <a name="powerpoint-non-security-updates"></a><span data-ttu-id="f4ee6-440">PowerPoint: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-440">PowerPoint: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-441">一部のアドインがグラフの図形に対して予期しないエラーをスローさせる問題を修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-441">Fixed an issue where some add-ins would throw unexpected errors around shapes in charts.</span></span>

### <a name="visio-non-security-updates"></a><span data-ttu-id="f4ee6-442">Visio: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-442">Visio: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-443">Visio から SVG へのエクスポートは、さまざまな図形に対して機能しませんでした。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-443">Export to SVG from Visio was not working for a variety of shapes.</span></span>

## <a name="version-1905-june-3"></a><span data-ttu-id="f4ee6-444">バージョン 1905: 6 月 3 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-444">Version 1905: June 3</span></span>
<span data-ttu-id="f4ee6-445">*バージョン 1905 (ビルド 11629.20214)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-445">*Version 1905 (Build 11629.20214)*</span></span>

### <a name="powerpoint-non-security-updates"></a><span data-ttu-id="f4ee6-446">PowerPoint: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-446">PowerPoint: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-447">一部のアドインがグラフの図形に対して予期しないエラーをスローさせる問題を修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-447">Fixed an issue where some addins would throw unexpected errors around shapes in charts.</span></span>

## <a name="version-1905-may-29"></a><span data-ttu-id="f4ee6-448">バージョン 1905: 5 月 29 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-448">Version 1905: May 29</span></span>
<span data-ttu-id="f4ee6-449">*バージョン 1905 (ビルド 11629.20196)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-449">*Version 1905 (Build 11629.20196)*</span></span>

### <a name="access-feature-updates"></a><span data-ttu-id="f4ee6-450">Access: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-450">Access: Feature updates</span></span>

- <span data-ttu-id="f4ee6-451">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-451">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-452">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-452">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-453">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-453">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-454">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-454">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-455">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-455">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-456">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-456">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-457">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-457">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

- <span data-ttu-id="f4ee6-458">**近日公開予定:** 近日公開予定の Office に対する魅力あふれる変更点を確認してお試しいただき、フィードバックをお寄せください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-458">**Coming Soon:** See what exciting changes are Coming Soon to Office, try them out and give us feedback.</span></span> [<span data-ttu-id="f4ee6-459">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-459">Learn more</span></span>](https://support.office.com/article/7800e0cf0-812f-475a-80aa-d47376e076f2)

- <span data-ttu-id="f4ee6-460">**コメント内で @メンションを使用してより効率的に共同作業を行う:** 共同作業がとても簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-460">**Collaborate more effectively with @Mentions in Comments:** Collaboration just became a whole lot easier!</span></span> <span data-ttu-id="f4ee6-461">ドキュメントのコメント内でチームメートを @メンションできるようになりました。ドキュメントに案内するメール通知が自動的にチームメートに送られます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-461">Now you can @mention teammates in document comments and they will automatically receive an email notification drawing them into the document.</span></span>

- <span data-ttu-id="f4ee6-462">**共同編集の結合の改善:** 条件付き書式、セルのスタイル、範囲の保護、グリッド線の表示、シート間の切り取り/貼り付けを使用する際に、共同編集での結合の成功率が改善されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-462">**Coauthoring merge improvements:** Coauthoring has improved the merge success rate when working with conditional formatting, cell styles, range protection, view gridlines, and cross-sheet cut/paste.</span></span> 

### <a name="outlook"></a><span data-ttu-id="f4ee6-463">Outlook</span><span class="sxs-lookup"><span data-stu-id="f4ee6-463">Outlook</span></span>

- <span data-ttu-id="f4ee6-464">**より簡単なアカウントの追加方法:** アカウントのセットアップの改善により、2 要素認証を使用する Outlook.com と Gmail のアカウントを Outlook に追加することが以前よりも簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-464">**A quicker way to add accounts:** Thanks to account setup improvements, it's easier than ever to add Outlook.com and Gmail accounts that use 2-factor authentication to Outlook.</span></span> [<span data-ttu-id="f4ee6-465">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-465">Learn more</span></span>](https://support.office.com/article/70191667-9c52-4581-990e-e30318c2c081)

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="f4ee6-466">PowerPoint: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-466">PowerPoint: Feature updates</span></span>

- <span data-ttu-id="f4ee6-467">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-467">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-468">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-468">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-469">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-469">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

- <span data-ttu-id="f4ee6-470">**ライブ キャプションと字幕:** 発表者の言葉が、キャプションまたは選択した言語での字幕として自動的に画面に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-470">**Live captions and subtitles:** The presenter’s words are automatically shown on screen as captions or translated into subtitles in the language of your choice.</span></span> [<span data-ttu-id="f4ee6-471">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-471">Learn more</span></span>](https://support.office.com/article/d68d20e49-aec3-456a-939d-34a79e8ddd5f)

- <span data-ttu-id="f4ee6-472">**近日公開予定:** 近日公開予定の Office に対する魅力あふれる変更点を確認してお試しいただき、フィードバックをお寄せください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-472">**Coming Soon:** See what exciting changes are Coming Soon to Office, try them out and give us feedback.</span></span> [<span data-ttu-id="f4ee6-473">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-473">Learn more</span></span>](https://support.office.com/article/7800e0cf0-812f-475a-80aa-d47376e076f2)

- <span data-ttu-id="f4ee6-474">**コメント内で @メンションを使用してより効率的に共同作業を行う:** 共同作業がとても簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-474">**Collaborate more effectively with @Mentions in Comments:** Collaboration just became a whole lot easier!</span></span> <span data-ttu-id="f4ee6-475">ドキュメントのコメント内でチームメートを @メンションできるようになりました。ドキュメントに案内するメール通知が自動的にチームメートに送られます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-475">Now you can @mention teammates in document comments and they will automatically receive an email notification drawing them into the document.</span></span>

### <a name="project-feature-updates"></a><span data-ttu-id="f4ee6-476">Project: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-476">Project: Feature updates</span></span>

- <span data-ttu-id="f4ee6-477">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-477">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-478">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-478">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-479">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-479">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

### <a name="visio-feature-updates"></a><span data-ttu-id="f4ee6-480">Visio: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-480">Visio: Feature updates</span></span>

- <span data-ttu-id="f4ee6-481">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-481">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-482">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-482">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-483">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-483">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

- <span data-ttu-id="f4ee6-484">**PDF または PPT にエクスポートされた、またはメール サブスクリプションをセットアップした Power BI レポートで、Visio Visual もサポートされるようになりました:** Power BI レポートを PDF または PPT にエクスポート、またはメール サブスクリプションにセットアップした場合、Visio Visual はこれらのエクスポート先の形式でシームレスにレンダリングされます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-484">**Power BI reports exported to PDF, PPT or set up for email subscription will now feature Visio Visual as well:** If you export your Power BI reports to PDF, PPT or set up an email subscription for them, Visio Visual will render in these exported formats seamlessly.</span></span> [<span data-ttu-id="f4ee6-485">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-485">Learn more</span></span>](https://support.office.com/article/4f09be62-f436-45c2-93b0-4a0f66b1f5a7)

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-486">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-486">Word: Feature updates</span></span>  

- <span data-ttu-id="f4ee6-487">**コメント内で @メンションを使用してより効率的に共同作業を行う:** 共同作業がとても簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-487">**Collaborate more effectively with @Mentions in Comments:** Collaboration just became a whole lot easier!</span></span> <span data-ttu-id="f4ee6-488">ドキュメントのコメント内でチームメートを @メンションできるようになりました。ドキュメントに案内するメール通知が自動的にチームメートに送られます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-488">Now you can @mention teammates in document comments and they will automatically receive an email notification drawing them into the document.</span></span>

- <span data-ttu-id="f4ee6-489">**シームレスな切り替え:** 新しいアカウント マネージャーでは、Office 365 の職場用と個人用アカウントがすべて 1 か所に表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-489">**Switch seamlessly:** The new account manager shows all of your Office 365 work and personal accounts in one place.</span></span> <span data-ttu-id="f4ee6-490">アカウント間の切り替えがより簡単になりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-490">Switching between them has never been easier.</span></span> [<span data-ttu-id="f4ee6-491">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-491">Learn more</span></span>](https://support.office.com/article/d17de17e-9f26-4dae-bd08-d7b8f46eb0b9)

- <span data-ttu-id="f4ee6-492">**[学習ツール] モードで、ページで使用できる色が増えました:** Word の学習ツールでは、より多くのページ テーマ色が追加され、ページの背景色を変更できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-492">**Learning Tools mode has additional support for more page colors:** Learning Tools in Word adds support for more page theme colors, which allows the changing of the background color of the page.</span></span>  <span data-ttu-id="f4ee6-493">すべて白またはすべて黒の背景だと読みにくいと感じるユーザーは少なくないため、PC と Mac の Word で色の選択肢を拡大しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-493">Many people have challenges reading with an all-white or all-black background, so we’ve expanded the choice of colors in Word on PC and Mac.</span></span>

- <span data-ttu-id="f4ee6-494">**近日公開予定:** 近日公開予定の Office に対する魅力あふれる変更点を確認してお試しいただき、フィードバックをお寄せください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-494">**Coming Soon:** See what exciting changes are Coming Soon to Office, try them out and give us feedback.</span></span> [<span data-ttu-id="f4ee6-495">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-495">Learn more</span></span>](https://support.office.com/article/7800e0cf0-812f-475a-80aa-d47376e076f2)

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="f4ee6-496">Skype for Business: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-496">Skype for Business: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-497">"ユーザーに自分を知ってもらうのに役立つ、写真の追加" コンテキストのヒントを無効にするオプションを Skype for Business Online ユーザーに提供します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-497">Provides the option to Skype for Business Online users to disable the "Add your photo - it'll help people get to know you" contextual tip.</span></span> <span data-ttu-id="f4ee6-498">この修正を有効にするには、[詳細情報](https://support.microsoft.com/help/4503469)を確認してください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-498">To enable this fix, you can [Learn more](https://support.microsoft.com/help/4503469).</span></span>

- <span data-ttu-id="f4ee6-499">Skype for Business の再起動後に、セカンダリ呼び出しの設定が常に有効になるのを防ぎます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-499">Prevents secondary ringer setting from always being enabled after restarting Skype for Business.</span></span> <span data-ttu-id="f4ee6-500">この修正を有効にするには、[詳細情報](https://support.microsoft.com/help/4503470)を確認してください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-500">To enable this fix, you can [Learn more](https://support.microsoft.com/help/4503470).</span></span>

 - <span data-ttu-id="f4ee6-501">Lync SDK ベースのアプリケーションを使用しながら、大規模な会議に参加するときに Skype for Business の応答を停止させる問題を修正します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-501">Fix for an issue that made Skype for Business stop responding when joining a large meeting while also using a Lync SDK-based application.</span></span> <span data-ttu-id="f4ee6-502">この修正を有効にするには、[詳細情報](https://support.microsoft.com/help/4503472)を確認してください。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-502">To enable this fix, you can [Learn more](https://support.microsoft.com/help/4503472).</span></span>

## <a name="version-1904-may-22"></a><span data-ttu-id="f4ee6-503">バージョン 1904: 5 月 22 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-503">Version 1904: May 22</span></span>
<span data-ttu-id="f4ee6-504">*バージョン 1904 (ビルド 11601.20230)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-504">*Version 1904 (Build 11601.20230)*</span></span>

### <a name="office-suite-non-security-updates"></a><span data-ttu-id="f4ee6-505">Office スイート: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-505">Office Suite: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-506">これにより、ユーザーがプライバシー レベルを選択して確認した後も、アプリケーションが起動される度に新しいプライバシー プロンプトが表示される問題を解決します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-506">This addresses an issue where users see the new Privacy Prompt on every application launch even after selecting and committing a choice for their privacy level.</span></span>

## <a name="version-1904-may-14"></a><span data-ttu-id="f4ee6-507">バージョン 1904: 5 月 14 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-507">Version 1904: May 14</span></span> 
<span data-ttu-id="f4ee6-508">*バージョン 1904 (ビルド 11601.20204)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-508">*Version 1904 (Build 11601.20204)*</span></span>

- <span data-ttu-id="f4ee6-509">セキュリティ更新プログラムの一覧は[こちら](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-509">Security updates listed [here](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)</span></span>

## <a name="version-1904-may-8"></a><span data-ttu-id="f4ee6-510">バージョン 1904: 5 月 8 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-510">Version 1904: May 8</span></span>
<span data-ttu-id="f4ee6-511">*バージョン 1904 (ビルド 11601.20178)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-511">*Version 1904 (Build 11601.20178)*</span></span>

- <span data-ttu-id="f4ee6-512">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-512">Various bugs and performances fixes.</span></span>

## <a name="version-1904-april-29"></a><span data-ttu-id="f4ee6-513">バージョン 1904: 4 月 29 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-513">Version 1904: April 29</span></span>
<span data-ttu-id="f4ee6-514">*バージョン 1904 (ビルド 11601.20144)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-514">*Version 1904 (Build 11601.20144)*</span></span>

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-515">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-515">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-516">**特定のファイルをすばやく見つける**: 最近作業を行ったファイルを探している場合は?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-516">**Find that file fast:** Looking for a file you worked on recently?</span></span> <span data-ttu-id="f4ee6-517">[ファイル] > [ホーム ページ] タブの検索ボックスに入力するだけで、目的のファイルを見つけることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-517">Just type in the Search box on the File > Home page to find the file you're looking for.</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="f4ee6-518">Outlook: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-518">Outlook: Feature updates</span></span>

- <span data-ttu-id="f4ee6-519">\*\* Outlook に LinkedIn ネットワークを接続する:\*\* LinkedIn アカウントを Microsoft アカウントに安全に接続して、LinkedIn プロファイルからの情報を [連絡先カード] に直接表示できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-519">**Connect your LinkedIn network with Outlook:** Securely connect your LinkedIn account with your Microsoft account to see information from LinkedIn profiles directly in the People card.</span></span> [<span data-ttu-id="f4ee6-520">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-520">Learn more</span></span>](https://support.office.com/article/98253fdc-a3c2-47e4-8852-ebb4fbed0bc5)

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="f4ee6-521">PowerPoint: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-521">PowerPoint: Feature updates</span></span>

- <span data-ttu-id="f4ee6-522">**特定のファイルをすばやく見つける**: 最近作業を行ったファイルを探している場合は?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-522">**Find that file fast:** Looking for a file you worked on recently?</span></span> <span data-ttu-id="f4ee6-523">[ファイル] > [ホーム ページ] タブの検索ボックスに入力するだけで、目的のファイルを見つけることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-523">Just type in the Search box on the File > Home page to find the file you're looking for.</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-524">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-524">Word: Feature updates</span></span>

- <span data-ttu-id="f4ee6-525">**色の変更履歴、コメントとリアルタイムの共同作業の同期:** 当社の製品での、コメント、変更履歴と共同作業者のカーソルが同じ色で表示されることについての修正箇所を確認しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-525">**Colors for Track Changes, Comments and Real-Time Collaboration in Sync:** Fixes in our product now ensure that the comments, track changes and the cursor for a collaborator show up in the same color.</span></span>

- <span data-ttu-id="f4ee6-526">**特定のファイルをすばやく見つける**: 最近作業を行ったファイルを探している場合は?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-526">**Find that file fast:** Looking for a file you worked on recently?</span></span> <span data-ttu-id="f4ee6-527">[ファイル] > [ホーム ページ] タブの検索ボックスに入力するだけで、目的のファイルを見つけることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-527">Just type in the Search box on the File > Home page to find the file you're looking for.</span></span>

### <a name="visio-feature-updates"></a><span data-ttu-id="f4ee6-528">Visio: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-528">Visio: Feature updates</span></span>

- <span data-ttu-id="f4ee6-529">**プロセス図を Word にエクスポート:** Word 文書に図形やメタデータなどのグラフ コンテンツを自動的に追加します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-529">**Export process diagrams to Word:** Automatically add diagram content, such as shapes and metadata, to a Word document.</span></span> <span data-ttu-id="f4ee6-530">その後に、文書をカスタマイズしてプロセスに関するガイドラインや操作マニュアルを作成できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-530">Then customize the document to create process guidelines and operation manuals.</span></span> [<span data-ttu-id="f4ee6-531">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-531">Learn more</span></span>](https://support.office.com/article/48073f4f-c6d4-4cc0-b9ae-3cb65e2ee158)

### <a name="office-suite-feature-updates"></a><span data-ttu-id="f4ee6-532">Office スイート: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-532">Office Suite: Feature updates</span></span>

- <span data-ttu-id="f4ee6-533">**新しいアイコン:** フィードバックに基づいて、300 を超える新しいアイコンが追加されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-533">**New icons:** We've added over 300 new icons based on your feedback.</span></span> <span data-ttu-id="f4ee6-534">[アイコン] ボタンを使用して、リボンの [挿入] タブに表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-534">You'll find them using the Icons button on the Insert tab of the ribbon.</span></span>

- <span data-ttu-id="f4ee6-535">**プライバシー制御**: 診断データおよび関連するエクスペリエンスに関する新しく更新されて改善された制御。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-535">**Privacy controls:** New, updated, and improved controls for diagnostic data and connected experiences.</span></span> [<span data-ttu-id="f4ee6-536">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-536">Learn more</span></span>](https://docs.microsoft.com/DeployOffice/privacy/overview-privacy-controls?toc=/deployoffice/toc.json)

### <a name="outlook-non-security-updates"></a><span data-ttu-id="f4ee6-537">Outlook: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-537">Outlook: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-538">件名が極端に小さくなる問題を修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-538">Fixed an issue causing the subject to show extremely small.</span></span>

### <a name="office-suite-non-security-updates"></a><span data-ttu-id="f4ee6-539">Office スイート: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-539">Office Suite: Non-security updates</span></span>
- <span data-ttu-id="f4ee6-540">新時代の名前である「Reiwa」のひらがなと漢字をスペルミスまたは間違った文法として誤って識別していた問題を修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-540">Fixed an issue of incorrectly identifying the new era name “Reiwa” in Hiragana and Kanji as a misspelled or ungrammatical expression.</span></span>

- <span data-ttu-id="f4ee6-541">プロキシ認証がシステムとして実行されたときに Office の更新プログラムがブロックされるという問題を修正しました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-541">Fixed an issue that blocked Office Updates when proxy authentication runs as SYSTEM.</span></span>

## <a name="version-1903-april-23"></a><span data-ttu-id="f4ee6-542">バージョン 1903: 4 月 23 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-542">Version 1903: April 23</span></span>
<span data-ttu-id="f4ee6-543">*バージョン 1903 (ビルド 11425.20244)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-543">*Version 1903 (Build 11425.20244)*</span></span>

- <span data-ttu-id="f4ee6-544">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-544">Various bugs and performances fixes.</span></span>

## <a name="version-1903-april-17"></a><span data-ttu-id="f4ee6-545">バージョン 1903: 4 月 17 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-545">Version 1903: April 17</span></span>
<span data-ttu-id="f4ee6-546">*バージョン 1903 (ビルド 11425.20228)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-546">*Version 1903 (Build 11425.20228)*</span></span>

- <span data-ttu-id="f4ee6-547">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-547">Various bugs and performances fixes.</span></span>

## <a name="version-1903-april-16"></a><span data-ttu-id="f4ee6-548">バージョン 1903: 4 月 16 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-548">Version 1903: April 16</span></span>
<span data-ttu-id="f4ee6-549">*バージョン 1903 (ビルド 11425.20218)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-549">*Version 1903 (Build 11425.20218)*</span></span>

- <span data-ttu-id="f4ee6-550">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-550">Various bugs and performances fixes.</span></span>

## <a name="version-1903-april-9"></a><span data-ttu-id="f4ee6-551">バージョン 1903: 4 月 9 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-551">Version 1903: April 9</span></span>
<span data-ttu-id="f4ee6-552">*バージョン 1903 (ビルド 11425.20204)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-552">*Version 1903 (Build 11425.20204)*</span></span> 

- <span data-ttu-id="f4ee6-553">セキュリティ更新プログラムの一覧は[こちら](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-553">Security updates listed [here](https://docs.microsoft.com/OfficeUpdates/office365-proplus-security-updates)</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="f4ee6-554">Skype for Business: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-554">Skype for Business: Non-security updates</span></span>
- <span data-ttu-id="f4ee6-555">Lync (Skype for Business) で、参加者が 7 人以上のオンライン ミーティングのミーティング ウィンドウが表示されないという問題が修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-555">Fixed an issue in Lync (Skype for Business) where for any online meeting with more 7+ participants, the meeting window can disappear.</span></span>

## <a name="version-1903-april-01"></a><span data-ttu-id="f4ee6-556">バージョン 1903: 4 月 1 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-556">Version 1903: April 01</span></span>
<span data-ttu-id="f4ee6-557">*Version 1903 (Build 11425.20202)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-557">*Version 1903 (Build 11425.20202)*</span></span> 

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-558">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-558">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-559">**Excel のインサイト:** インサイトには、ユーザーの範囲に値が用意されています。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-559">**Insights in Excel:** Insights provides value to a range of users.</span></span> <span data-ttu-id="f4ee6-560">インサイトは、データ分析にソフトなアプローチを提供し、データに他からの違う視点を提供します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-560">Insights provides a softer approach to data analysis and for others it provides a different perspective to your data.</span></span> [<span data-ttu-id="f4ee6-561">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-561">Learn more</span></span>](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4)


- <span data-ttu-id="f4ee6-562">**コンテンツのリーチを拡大:** アクセシビリティの高いスプレッドシートを作成する必要がありますか?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-562">**Increase the reach of your content:**  Need to make your spreadsheets accessible?</span></span> <span data-ttu-id="f4ee6-563">アクセシビリティ チェックを使用すると、アクセシビリティの問題を自動的に監視できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-563">Let the accessibility checker keep an eye on it for you, without getting in the way.</span></span> <span data-ttu-id="f4ee6-564">[校閲] > [アクセシビリティ チェック] をクリックすると、何か問題が見つかった場合に、ステータス バーに通知が表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-564">Try it by clicking Review > Check Accessibility and we’ll tell you when we find something you need to look at in the status bar.</span></span>

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="f4ee6-565">PowerPoint: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-565">PowerPoint: Feature updates</span></span>

- <span data-ttu-id="f4ee6-566">**よりよい変形操作:** 図形に名前を付けると、変形するときにより細かく制御できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-566">**Better shapeshifting:**  Name your shapes for more control over how they morph.</span></span> [<span data-ttu-id="f4ee6-567">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-567">Learn more</span></span>](https://support.office.com/article/9bc7f48ff-f152-4ee8-9081-d3121788024f)

- <span data-ttu-id="f4ee6-568">**コンテンツのリーチを拡大:** アクセシビリティの高いプレゼンテーションを作成する必要がありますか?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-568">**Increase the reach of your content:**  Need to make your presentations accessible?</span></span> <span data-ttu-id="f4ee6-569">アクセシビリティ チェックを使用すると、アクセシビリティの問題を自動的に監視できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-569">Let the accessibility checker keep an eye on it for you, without getting in the way.</span></span> <span data-ttu-id="f4ee6-570">[校閲]>[アクセシビリティ チェック] をクリックすると、何か問題が見つかった場合に、ステータス バーに通知が表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-570">Try it by clicking Review > Check Accessibility – we’ll tell you when we find something you need to look at in the status bar.</span></span>

- <span data-ttu-id="f4ee6-571">**再利用できる場合、新たに作成し直しますか?**</span><span class="sxs-lookup"><span data-stu-id="f4ee6-571">**Why reinvent when you can re-use?**</span></span>  <span data-ttu-id="f4ee6-572">作成した、または他のユーザーと共有しているスライドを再利用して時間を節約します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-572">Save time by re-using slides that you created or that others have shared with you.</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="f4ee6-573">Excel: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-573">Excel: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-574">Excel では、ユーザーが変更を取得するためにブックを再び開くよう要求される結果となるマージ競合の問題が修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-574">Fixed a merge conflict issue in Excel  that would result in users being prompted to reopen workbook to pick up the changes.</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="f4ee6-575">Skype for Business: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-575">Skype for Business: Non-security updates</span></span>

- <span data-ttu-id="f4ee6-576">サード パーティの SfB/Lync SDK アプリが存在する場合に、Skype for Business のチャット通知への応答が停止される原因となった問題を修正します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-576">Fix for issue that caused Skype for Business to stop responding when responding to chat notifications if 3rd party SfB/Lync SDK app present.</span></span>
- <span data-ttu-id="f4ee6-577">チャットに特定のクリップボードの内容を貼り付けるときにアプリがクラッシュする問題を修正します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-577">Fix for app crash when specific clipboard content is pasted into a chat.</span></span>
- <span data-ttu-id="f4ee6-578">いずれかの通話エージェントが受信した呼び出しキューの呼び出しの "受け入れ担当者" 情報が表示されるのを妨げている問題を修正します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-578">Fix for issue that prevented display of the "accepted by" information for a Call Queue call that's picked up by one of the call agents.</span></span>
- <span data-ttu-id="f4ee6-579">Teams のユーザーが Skype for Business 会議に参加したときに通話アイコンが非表示になる問題が修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-579">Fixed issue that hid call icons when a Teams user joins a Skype for Business meeting.</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-580">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-580">Word: Feature updates</span></span>

- <span data-ttu-id="f4ee6-581">**コンテンツのリーチを拡大:** アクセシビリティの高いドキュメントを作成する必要がありますか?</span><span class="sxs-lookup"><span data-stu-id="f4ee6-581">**Increase the reach of your content:**  Need to make your documents accessible?</span></span> <span data-ttu-id="f4ee6-582">アクセシビリティ チェックを使用すると、アクセシビリティの問題を自動的に監視できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-582">Let the accessibility checker keep an eye on it for you, without getting in the way.</span></span> <span data-ttu-id="f4ee6-583">[校閲]>[アクセシビリティ チェック] をクリックすると、何か問題が見つかった場合に、ステータス バーに通知が表示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-583">Try it by clicking Review > Check Accessibility – we’ll tell you when we find something you need to look at in the status bar.</span></span>

## <a name="version-1902-march-25"></a><span data-ttu-id="f4ee6-584">バージョン 1902: 3 月 25 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-584">Version 1902: March 25</span></span>
<span data-ttu-id="f4ee6-585">*バージョン 1902 (ビルド 11328.20222)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-585">*Version 1902 (Build 11328.20222)*</span></span>

- <span data-ttu-id="f4ee6-586">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-586">Various bugs and performances fixes.</span></span>

## <a name="version-1902-march-12"></a><span data-ttu-id="f4ee6-587">バージョン 1902: 3 月 12 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-587">Version 1902: March 12</span></span>
<span data-ttu-id="f4ee6-588">*バージョン 1902 (ビルド 11328.20158)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-588">*Version 1902 (Build 11328.20158)*</span></span> 

- <span data-ttu-id="f4ee6-589">さまざまなバグやパフォーマンスが修正されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-589">Various bugs and performances fixes.</span></span>

## <a name="version-1902-march-4"></a><span data-ttu-id="f4ee6-590">バージョン 1902: 3 月 4 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-590">Version 1902: March 4</span></span>
<span data-ttu-id="f4ee6-591">*バージョン 1902 (ビルド 11328.20146)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-591">*Version 1902 (Build 11328.20146)*</span></span> 

### <a name="access-feature-updates"></a><span data-ttu-id="f4ee6-592">Access: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-592">Access: Feature updates</span></span>

- <span data-ttu-id="f4ee6-593">**データベース オブジェクトをタブで管理する:** アクティブなタブが分かりやすく表示され、簡単にタブをドラッグして再配置し、ワンクリックでデータベース オブジェクトを閉じることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-593">**Keep tabs on your database objects:** Clearly see the active tab, easily drag tabs to rearrange them, and close database objects with just one click.</span></span>
- <span data-ttu-id="f4ee6-594">**より大きい [ズーム] ボックス:** [ズーム] ボックスがより大きく表示され、そこでフォントを変更することができます。変更内容はすべて [ズーム] ボックス内に記憶されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-594">**Zoom with more room:** Make the Zoom box bigger, change the font, and Zoom remembers it all.</span></span> [<span data-ttu-id="f4ee6-595">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-595">Learn more</span></span>](https://support.office.com/article/9a62d165-67f8-4790-bad8-a2c2e83dcedf)

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-596">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-596">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-597">**\@メンションを使用してユーザーの注意を引く:** コメントで @メンションを使うと、仕事仲間による入力が必要な場合にそのユーザーに知らせることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-597">**Get their attention with \@mentions:** Use @mentions in comments to let co-workers know when you need their input.</span></span> [<span data-ttu-id="f4ee6-598">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-598">Learn more</span></span>](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)
- <span data-ttu-id="f4ee6-599">**データの詳細を検出する:** 新しいアイデア ボタンは、データのパターンを探し、それを使用してインテリジェントな個人向けの提案を作成します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-599">**Discover more about your data:** The new Ideas button looks for patterns in your data, and uses them to create intelligent, personalized suggestions.</span></span> [<span data-ttu-id="f4ee6-600">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-600">Learn more</span></span>](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4)
- <span data-ttu-id="f4ee6-601">**変更が発生したときに変更内容を自動的に保存する:** 変更が自動的に保存されるように、ファイルを OneDrive にアップロードしましょう。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-601">**Save your changes as they happen:** Upload your file to OneDrive to make sure all your updates are saved automatically.</span></span>
- <span data-ttu-id="f4ee6-602">**フィルターが適用された SVG を挿入する機能:** Office ユーザーは、フィルターが適用された SVG を挿入できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-602">**Ability to insert SVG's with filters applied:** Office users now have the ability to insert SVG's that have filters applied to them.</span></span> [<span data-ttu-id="f4ee6-603">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-603">Learn more</span></span>](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)

### <a name="outlook-feature-updates"></a><span data-ttu-id="f4ee6-604">Outlook: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-604">Outlook: Feature updates</span></span>

- <span data-ttu-id="f4ee6-605">**連続する会議の合間に時間を組み込む:** 既定で 5 分から 10 分早く会議を終了するように設定することで、出席者に休憩時間や場所の移動時間を与えることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-605">**Build in time between back-to-back meetings:** Give attendees time to catch their breath or travel between locations by setting meetings to end 5-10 minutes early by default.</span></span> [<span data-ttu-id="f4ee6-606">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-606">Learn more</span></span>](https://support.office.com/article/Schedule-a-meeting-with-other-people-5C9877BC-AB91-4A7C-99FB-B0B68D7EA94F#BKMK_endmeetingsearly)
- <span data-ttu-id="f4ee6-607">**音声読み上げを使用してメールの内容を聞く:** Outlook では、メールのテキストを読み上げながら強調表示することができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-607">**Use Read Aloud to listen to your email:** Outlook can read your email aloud, highlighting text as it's read.</span></span> <span data-ttu-id="f4ee6-608">読み上げ機能をオンにするには、[簡単操作] の設定に移動します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-608">To turn on Read Aloud, go to the Ease of Access settings.</span></span> [<span data-ttu-id="f4ee6-609">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-609">Learn more</span></span>](https://support.office.com/article/64e393a4-1229-45c0-acdb-dc93330ebdb3)
- <span data-ttu-id="f4ee6-610">**フィルターが適用された SVG を挿入する機能:** Office ユーザーは、フィルターが適用された SVG を挿入できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-610">**Ability to insert SVG's with filters applied:** Office users now have the ability to insert SVG's that have filters applied to them.</span></span> [<span data-ttu-id="f4ee6-611">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-611">Learn more</span></span>](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="f4ee6-612">PowerPoint: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-612">PowerPoint: Feature updates</span></span>

- <span data-ttu-id="f4ee6-613">**これまで以上に簡単にオンライン ビデオを挿入できるようになりました:** Vimeo または YouTube からビデオをスライドに挿入する場合は、</span><span class="sxs-lookup"><span data-stu-id="f4ee6-613">**Inserting an online video is easier than ever:** Want to put a video from Vimeo or YouTube on your slide?</span></span> <span data-ttu-id="f4ee6-614">ビデオ ページへのリンクがあれば簡単に行えます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-614">The video page link is all you need.</span></span> [<span data-ttu-id="f4ee6-615">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-615">Learn more</span></span>](https://support.office.com/article/8340ec69-4cee-4fe1-ab96-4849154bc6db)
- <span data-ttu-id="f4ee6-616">**手書きの数式の自動書式設定:** 手書きの数式を標準の文字に変換することができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-616">**You compute, we format:** We change hand-drawn math expressions into standard characters.</span></span> <span data-ttu-id="f4ee6-617">変換を開始するには、[インクから数式] を選択して、手書きのメモを選択します。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-617">Just choose Ink to Math and select your handwritten notes to get started.</span></span> [<span data-ttu-id="f4ee6-618">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-618">Learn more</span></span>](https://support.office.com/article/0740dec3-6291-4c1f-8baa-011d18449919)
- <span data-ttu-id="f4ee6-619">**変更が発生したときに変更内容を自動的に保存する:** 変更が自動的に保存されるように、ファイルを OneDrive にアップロードしましょう。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-619">**Save your changes as they happen:** Upload your file to OneDrive to make sure all your updates are saved automatically.</span></span>
- <span data-ttu-id="f4ee6-620">**フィルターが適用された SVG を挿入する機能:** Office ユーザーは、フィルターが適用された SVG を挿入できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-620">**Ability to insert SVG's with filters applied:** Office users now have the ability to insert SVG's that have filters applied to them.</span></span> [<span data-ttu-id="f4ee6-621">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-621">Learn more</span></span>](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
- <span data-ttu-id="f4ee6-622">**大きなファイルがより速く開くようになりました:** OneDrive または SharePoint に保存されているファイルを開くと、画像、ビデオ、およびその他の大きな要素がバックグラウンドでダウンロードされるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-622">**Large files now open faster:** Images, videos, and other large elements now download in the background when opening files stored on OneDrive or SharePoint.</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-623">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-623">Word: Feature updates</span></span>

- <span data-ttu-id="f4ee6-624">**変更が発生したときに変更内容を自動的に保存する:** 変更が自動的に保存されるように、ファイルを OneDrive にアップロードしましょう。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-624">**Save your changes as they happen:** Upload your file to OneDrive to make sure all your updates are saved automatically.</span></span>
- <span data-ttu-id="f4ee6-625">**自動保存がオンになっていない理由を確認する**</span><span class="sxs-lookup"><span data-stu-id="f4ee6-625">**Find out why AutoSave isn't on!**</span></span> <span data-ttu-id="f4ee6-626">自動保存がオフになっているときに自動保存トグルをクリックすると、吹き出しが表示されるようになりました。自動保存がオフになっている理由も示されます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-626">Clicking on the AutoSave toggle when it's off will now either display a helpful callout with reasons why AutoSave might be off.</span></span> <span data-ttu-id="f4ee6-627">ドキュメントが OneDrive または SharePoint 上に存在しないという理由で自動保存ができない場合でも、1 つのボタンをクリックするだけでドキュメントを移動することができるようになります。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-627">In the case where the only reason preventing AutoSave is the fact that the document is not on OneDrive or SharePoint, we will offer to move the document conveniently with one button click!</span></span>
- <span data-ttu-id="f4ee6-628">**フィルターが適用された SVG を挿入する機能:** Office ユーザーは、フィルターが適用された SVG を挿入できるようになりました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-628">**Ability to insert SVG's with filters applied:** Office users now have the ability to insert SVG's that have filters applied to them.</span></span> [<span data-ttu-id="f4ee6-629">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-629">Learn more</span></span>](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
 
### <a name="office-suite-feature-updates"></a><span data-ttu-id="f4ee6-630">Office スイート: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-630">Office Suite: Feature updates</span></span>

- <span data-ttu-id="f4ee6-631">**Microsoft Teams のインストール:** Microsoft Teams は、Office 365 ProPlus の新規インストール用に既定でインストールされています。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-631">**Installation of Microsoft Teams:**  Microsoft Teams is installed by default for new installations of Office 365 ProPlus.</span></span> [<span data-ttu-id="f4ee6-632">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-632">Learn More</span></span>](https://docs.microsoft.com/DeployOffice/teams-install)

## <a name="version-1901-february-12"></a><span data-ttu-id="f4ee6-633">バージョン 1901: 2 月 12 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-633">Version 1901: February 12</span></span>
<span data-ttu-id="f4ee6-634">*バージョン 1901 (ビルド 11231.20174)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-634">*Version 1901 (Build 11231.20174)*</span></span> 

<span data-ttu-id="f4ee6-635">セキュリティ更新プログラムの一覧は[こちら](office365-proplus-security-updates.md)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-635">Security updates listed [here](office365-proplus-security-updates.md)</span></span>

## <a name="version-1901-january-31"></a><span data-ttu-id="f4ee6-636">バージョン 1901: 1 月 31 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-636">Version 1901: January 31</span></span>
<span data-ttu-id="f4ee6-637">*バージョン 1901 (ビルド 11231.20130)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-637">*Version 1901 (Build 11231.20130)*</span></span> 

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-638">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-638">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p199">**コメントを利用して共同作業を行う:** 返信ボックスが組み込まれているので、スプレッドシートで直接会話を続けることができます。[詳細情報](https://support.office.com/article/bdcc9f5d-38e2-45b4-9a92-0b2b5c7bf6f8)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p199">**Collaborate with comments:** Keep the conversation going right in your spreadsheet with the built-in reply box. [Learn more](https://support.office.com/article/bdcc9f5d-38e2-45b4-9a92-0b2b5c7bf6f8)</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="f4ee6-641">Outlook: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-641">Outlook: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p200">**ミームが表示される:** テキストまたは静的イメージだけでは十分ではない場合、アニメーション GIF を使用して要点を示すことができます。[詳細情報](https://support.office.com/article/114BB251-861F-41CD-B20F-7E7289630C5B)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p200">**They'll see what you meme:** When text or static images just won't do, use an animated GIF to make your point. [Learn more](https://support.office.com/article/114BB251-861F-41CD-B20F-7E7289630C5B)</span></span>
 
### <a name="visio-feature-updates"></a><span data-ttu-id="f4ee6-644">Visio: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-644">Visio: Feature updates</span></span>

- <span data-ttu-id="f4ee6-645">**ダブル テイク オン データ フローチャート:** データ ビジュアライザーのフローチャート用の新しいレイアウトは、きれいで鮮明でとても分かりやすいです。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-645">**Double-take on data flowcharts:** Gorgeous new layouts for Data Visualizer flowcharts are clean, crisp, and easy to understand.</span></span> [<span data-ttu-id="f4ee6-646">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-646">Learn more</span></span>](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6)

- <span data-ttu-id="f4ee6-647">**Azure ステンシルが組み込まれました:** 豊富な Azure ステンシルを使用してクラウド アプリの設計やアーキテクチャの計画を行うことができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-647">**Azure stencils built right in:** Design a cloud app or plan an architecture using dozens of Azure stencils.</span></span> [<span data-ttu-id="f4ee6-648">詳細情報</span><span class="sxs-lookup"><span data-stu-id="f4ee6-648">Learn more</span></span>](https://support.office.com/article/efbb25e7-c80e-42e1-b1ad-7ef630ff01b7)

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-649">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-649">Word: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p203">**静的なドキュメントから魅力的なドキュメントへの変換:** ドキュメントを、すべてのデバイスに対応する対話型の使いやすい Web ページに変換します。[詳細情報](https://support.office.com/article/65912b2d-8b81-41e1-ac52-c20a65ce8ecf)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p203">**Take your doc from static to stunning:** Transform your document into an interactive, easy-to-share web page that looks great on any device. [Learn more](https://support.office.com/article/65912b2d-8b81-41e1-ac52-c20a65ce8ecf)</span></span>

### <a name="office-suite-feature-updates"></a><span data-ttu-id="f4ee6-652">Office スイート: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-652">Office Suite: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p204">**Office のサード パーティ アプリケーションでは office.js api を使用した SVG の挿入をサポート:** Office アドインとも呼ばれるサード パーティ アプリケーションで SVG を挿入できるようになりました。ユーザーは、個人の SVG コレクションを Office に結び付けることができます。開発者は、Office.js API を使用してこの機能を利用できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p204">**Office 3rd Party Applications now have insert SVG support using the office.js api:** 3rd party applications also known as add-ins in Office now have the ability to insert SVG's. Users can now connect their personal collection of SVG's to Office. Developers can use this feature by using the Office.js API.</span></span>


## <a name="version-1812-january-14"></a><span data-ttu-id="f4ee6-656">バージョン 1812: 1 月 14 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-656">Version 1812: January 14</span></span>
<span data-ttu-id="f4ee6-657">*バージョン 1812 (ビルド 11126.20266)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-657">*Version 1812 (Build 11126.20266)*</span></span> 

<span data-ttu-id="f4ee6-658">パフォーマンス上の問題に対処するセキュリティ関連ではない更新プログラムのみ。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-658">Non-security updates only, addressing performance issues.</span></span>

## <a name="version-1812-january-8"></a><span data-ttu-id="f4ee6-659">バージョン 1812: 1 月 8 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-659">Version 1812: January 8</span></span>
<span data-ttu-id="f4ee6-660">*バージョン 1812 (ビルド 11126.20196)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-660">*Version 1812 (Build 11126.20196)*</span></span> 

### <a name="project-non-security-updates"></a><span data-ttu-id="f4ee6-661">Project: セキュリティ以外の更新プログラム</span><span class="sxs-lookup"><span data-stu-id="f4ee6-661">Project: Non-security updates</span></span>
- <span data-ttu-id="f4ee6-662">ガント チャートの [クリティカル]、[遅延]、[余裕期間] バー スタイルをオンにした後でオフにできない問題が解決されました。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-662">Fixed an issue where you couldn't uncheck the Critical, Late and Slack bar styles for the Gantt chart after you checked one.</span></span>

## <a name="version-1812-january-3"></a><span data-ttu-id="f4ee6-663">バージョン 1812: 1 月 3 日</span><span class="sxs-lookup"><span data-stu-id="f4ee6-663">Version 1812: January 3</span></span>
<span data-ttu-id="f4ee6-664">*バージョン 1812 (ビルド 11126.20188)*</span><span class="sxs-lookup"><span data-stu-id="f4ee6-664">*Version 1812 (Build 11126.20188)*</span></span> 

### <a name="excel-feature-updates"></a><span data-ttu-id="f4ee6-665">Excel: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-665">Excel: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p205">**作業中にアクセシビリティ チェックを実行したままにする:** アクセシビリティ チェックを常に開いたままにしなくても、ドキュメントのアクセシビリティの問題を追跡できます。スペルチェックの場合のように、ステータス バーのインジケーターを介して、作業中に見つかったアクセシビリティの問題に Excel が自動的にフラグを付けます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p205">**Keep accessibility checker running while you work:** Keep track of accessibility issues in your document without needing the accessibility checker always open. Via an indicator in the status bar, much like spellcheck, Excel flags found accessibility issues while you are working.</span></span> 

### <a name="outlook-feature-updates"></a><span data-ttu-id="f4ee6-668">Outlook: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-668">Outlook: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p206">**すべての暗号化オプションを 1 か所に集約:** [オプション] > [暗号化] の順に移動するだけで、電子メール メッセージを保護する方法を選択できます。[詳細情報](https://support.office.com/article/373339cb-bf1a-4509-b296-802a39d801dc)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p206">**All your encryption options in one place:** Just go to Options > Encrypt to choose how to secure your email message. [Learn more](https://support.office.com/article/373339cb-bf1a-4509-b296-802a39d801dc)</span></span>


### <a name="powerpoint-feature-updates"></a><span data-ttu-id="f4ee6-671">PowerPoint: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-671">PowerPoint: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p207">**インクで素晴らしいスライドを作成:** インクを標準的な図形とテキストに変換し、PowerPoint デザイナーからスマートなスライド デザイン アイデアを入手します。[詳細情報](https://support.office.com/article/53c77d7b-dc40-45c2-b684-81415eac0617)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p207">**Ink a splendid slide:** Convert your ink to standard shapes and text, then get smart slide-design ideas from PowerPoint Designer. [Learn more](https://support.office.com/article/53c77d7b-dc40-45c2-b684-81415eac0617)</span></span>
- <span data-ttu-id="f4ee6-p208">**作業中にアクセシビリティ チェックを実行したままにする:** アクセシビリティ チェックを常に開いたままにしなくても、ドキュメントのアクセシビリティの問題を追跡できます。スペルチェックの場合のように、ステータス バーのインジケーターを介して、作業中に見つかったアクセシビリティの問題に PowerPoint が自動的にフラグを付けます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p208">**Keep accessibility checker running while you work:** Keep track of accessibility issues in your document without needing the accessibility checker always open. Via an indicator in the status bar, much like spellcheck, PowerPoint flags found accessibility issues while you are working.</span></span> 

### <a name="word-feature-updates"></a><span data-ttu-id="f4ee6-676">Word: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-676">Word: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p209">**行フォーカスによる読解力の向上:** ドキュメント内で行ごとの移動をスムーズに行います。一度に 1 行か、3 行か、5 行かを表示するようフォーカスを調整できます。[詳細情報](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p209">**Improve comprehension with Line Focus:** Move through a document line by line without distractions. Adjust the focus to put one, three, or five lines in view at a time. [Learn more](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)</span></span>
- <span data-ttu-id="f4ee6-p210">**作業中にアクセシビリティ チェックを実行したままにする:** アクセシビリティ チェックを常に開いたままにしなくても、ドキュメントのアクセシビリティの問題を追跡できます。スペルチェックの場合のように、ステータス バーのインジケーターを介して、作業中に見つかったアクセシビリティの問題に Word が自動的にフラグを付けます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p210">**Keep accessibility checker running while you work:** Keep track of accessibility issues in your document without needing the accessibility checker always open. Via an indicator in the status bar, much like spellcheck, Word flags found accessibility issues while you are working.</span></span>

### <a name="visio-feature-updates"></a><span data-ttu-id="f4ee6-682">Visio: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-682">Visio: Feature updates</span></span>

- <span data-ttu-id="f4ee6-p211">**壊れた Excel リンクの問題を解消:** データ ビジュアライザーの図にリンクされているはずの Excel ブックが見つかりませんか? 再リンクして、すぐに業務を再開できます。[詳細情報](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6)</span><span class="sxs-lookup"><span data-stu-id="f4ee6-p211">**Say goodbye to broken Excel links:** Can't find the Excel workbook linked to your Data Visualizer diagram? Relink it, and you're back in business. [Learn more](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6)</span></span>

### <a name="office-suite-feature-updates"></a><span data-ttu-id="f4ee6-686">Office スイート: 機能の更新</span><span class="sxs-lookup"><span data-stu-id="f4ee6-686">Office Suite: Feature updates</span></span>

- <span data-ttu-id="f4ee6-687">**[新機能] ウィンドウ:** [新機能] はヘルプ ウィンドウに移行しました。そのため、最新の更新プログラムにより簡単にアクセスして最新情報を入手できます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-687">**What's New Pane:** The What's New experience has moved to the Help Pane, so you can more easily access and stay up to date with our latest updates.</span></span>

> [!NOTE]
> <span data-ttu-id="f4ee6-688">Office の使用で問題がある場合は、[Microsoft の回答フォーラム](https://answers.microsoft.com/)に関するページまたは「[Microsoft Tech Community](https://techcommunity.microsoft.com/)」に質問を投稿するか、[サポート](https://support.microsoft.com/contactus)に問い合わせてサポートを受けることができます。</span><span class="sxs-lookup"><span data-stu-id="f4ee6-688">If you need help with an issue with using Office, we recommend that you post your question on [Microsoft's Answers forum](https://answers.microsoft.com/) or [Tech Community](https://techcommunity.microsoft.com/), or you can contact [support](https://support.microsoft.com/contactus).</span></span>
