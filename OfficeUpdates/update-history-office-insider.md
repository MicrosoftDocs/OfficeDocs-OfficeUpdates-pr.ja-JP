...
> [!IMPORTANT]
> - 新しい更新プログラムチャネル (月次エンタープライズチャネル) の追加、既存の更新プログラムチャネルの名前の変更など、Microsoft 365 アプリの更新プログラムチャネルにいくつかの変更を加えています。 詳細については、[この記事を参照](https://go.microsoft.com/fwlink/p/?linkid=2127441)してください。
