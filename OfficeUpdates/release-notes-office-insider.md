...
- <div><span>信頼されていないネットワーク共有から保護されたファイルを編集すると、Excel がクラッシュすることがある問題を解決しました</span></div>


- <div>別のシートのデータを参照しているスパークラインを含むシートを削除すると、再びそのファイルを開いた時に破損したファイルとして識別されるという問題を解決しました。</div>


- <div>SQL 表形式サーバーのクエリのピボットテーブルの残りの部分と一緒にレポート フィルターを変換すると、正しい結果が返されないことがある問題を解決しました。</span></div>


- <div><span>ナレーターと拡大鏡を同時に使用すると、クラッシュする場合がある問題</span></div>
...
- <div>メールを転送すると、埋め込み画像がなくなる場合がある問題</div>


- <div><span>会議室の検索ツールで、使用可能な会議室が&quot;なし&quot;と表示される場合がある問題</span></div>


- <div><span>厳しいテナント制限がある Outlook プロファイルをユーザーが作成できない場合がある問題</div></span>
...
- <div><span>ユーザーがタスクを完了としてマークすることができず、99% に設定される問題</span></div>


- <div>平準化によって割り当て超過が解決されない問題</div>
...
- <div><span>以前のドキュメントを開いたまま [情報] タブに移動すると、クラッシュする場合がある問題</span></div>


- <div><span>文章校正の候補がコンテキスト メニューに表示されない問題</span></div>


- <div><span>コンテンツ ポリシーがコメントに正しく適用されない問題</span></div>


- <div><span>濃色のテキストで書かれた従来のコメントがダーク モードで表示されない問題</span></div>


- <div><span>韓国語/英語のオートコレクトを使用しているときに、間違った文字が表示される場合がある問題</span></div>


- <div><span>上位のポリシー ラベルが優先して適用されるべき時に、低いポリシー ラベルが適用される場合がある問題</div></span>


- <div><span>Outlook メッセージからの cid: 画像のリンク&nbsp;が、要求があったときに正常に分割できるようになりました。</div></span>


- <div><span>ナレーターと拡大鏡を同時に使用すると、クラッシュする場合がある問題</span></div>


- <div><span>ナビゲーション ウィンドウから検索できない場合がある問題</span></div>


### <a name="office-suite"></a>Office スイート

- <div><span>一部の描画がプレビューやスライドショーに表示されない場合がある問題</span></div>


- <div><span>縦書きのテキスト ボックス内で一部のカタカナが正しく表示されないことがある問題</span></div>


- <div>接続されていないネットワーク共有にファイルを保存しようとすると、クラッシュする場合がある問題</div>
